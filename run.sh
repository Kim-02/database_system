...
for mm in 128 256 512 1024; do
  ...
  avg_tc "M${mm}_L8192_R1024"  "$mm" 8192 1024
  avg_tc "M${mm}_L8192_R2048"  "$mm" 8192 2048
  avg_tc "M${mm}_L8192_R4096"  "$mm" 8192 4096
  avg_tc "M${mm}_L8192_R8192"  "$mm" 8192 8192
  avg_tc "M${mm}_L8192_R16384" "$mm" 8192 16384
done

for mm in 128 256 512 1024; do
  avg_tc "M${mm}_L1024_R4096"  "$mm" 1024 4096
  avg_tc "M${mm}_L2048_R4096"  "$mm" 2048 4096
  avg_tc "M${mm}_L4096_R4096"  "$mm" 4096 4096
  avg_tc "M${mm}_L8192_R4096"  "$mm" 8192 4096
  avg_tc "M${mm}_L16384_R4096" "$mm" 16384 4096

  avg_tc "M${mm}_L1024_R8192"  "$mm" 1024 8192
  avg_tc "M${mm}_L2048_R8192"  "$mm" 2048 8192
  avg_tc "M${mm}_L4096_R8192"  "$mm" 4096 8192
  avg_tc "M${mm}_L8192_R8192"  "$mm" 8192 8192
  avg_tc "M${mm}_L16384_R8192" "$mm" 16384 8192
done